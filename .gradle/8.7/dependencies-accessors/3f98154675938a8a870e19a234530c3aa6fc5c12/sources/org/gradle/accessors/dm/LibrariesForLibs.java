...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final AmplitudeLibraryAccessors laccForAmplitudeLibraryAccessors = new AmplitudeLibraryAccessors(owner);
    private final BugsnagLibraryAccessors laccForBugsnagLibraryAccessors = new BugsnagLibraryAccessors(owner);
    ...
    private final KonfettiLibraryAccessors laccForKonfettiLibraryAccessors = new KonfettiLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>orchestrator</b> with <b>androidx.test:orchestrator</b> coordinates and
     * with version reference <b>orchestrator</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
     ...
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getWear() {
        return create("wear");
    }
    ...
    /**
     * Group of libraries at <b>amplitude</b>
     */
    public AmplitudeLibraryAccessors getAmplitude() {
        return laccForAmplitudeLibraryAccessors;
    }

    /**
     * Group of libraries at <b>bugsnag</b>
     */
    public BugsnagLibraryAccessors getBugsnag() {
        return laccForBugsnagLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>konfetti</b>
     */
    public KonfettiLibraryAccessors getKonfetti() {
        return laccForKonfettiLibraryAccessors;
    }
    ...
    public static class AcraLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>acra</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Dependency provider for <b>limiter</b> with <b>ch.acra:acra-limiter</b> coordinates and
         * with version reference <b>acra</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLimiter() {
            return create("acra.limiter");
        }

        /**
         * Dependency provider for <b>mail</b> with <b>ch.acra:acra-mail</b> coordinates and
         * with version reference <b>acra</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getMail() {
            return create("acra.mail");
        }
    ...
    public static class AmplitudeLibraryAccessors extends SubDependencyFactory {

        public AmplitudeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.amplitude:android-sdk</b> coordinates and
         * with version reference <b>amplitude</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSdk() {
            return create("amplitude.sdk");
        }

    }

    public static class BugsnagLibraryAccessors extends SubDependencyFactory {

        public BugsnagLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.bugsnag:bugsnag-android</b> coordinates and
         * with version reference <b>bugsnagAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("bugsnag.android");
        }
    ...
    public static class GoogleLibraryAccessors extends SubDependencyFactory {
        private final GoogleBillingLibraryAccessors laccForGoogleBillingLibraryAccessors = new GoogleBillingLibraryAccessors(owner);

        public GoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>google.billing</b>
         */
        public GoogleBillingLibraryAccessors getBilling() {
            return laccForGoogleBillingLibraryAccessors;
        }

    }

    public static class GoogleBillingLibraryAccessors extends SubDependencyFactory {

        public GoogleBillingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("google.billing.ktx");
        }
    ...
    public static class KonfettiLibraryAccessors extends SubDependencyFactory {

        public KonfettiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>xml</b> with <b>nl.dionsegijn:konfetti-xml</b> coordinates and
         * with version reference <b>konfettiXml</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getXml() {
            return create("konfetti.xml");
        }
    ...
    public static class LibgdxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>libgdx</b> with <b>com.badlogicgames.gdx:gdx</b> coordinates and
         * with version reference <b>gdx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("libgdx");
        }
    ...
    public static class PlayLibraryAccessors extends SubDependencyFactory {
        private final PlayCoreLibraryAccessors laccForPlayCoreLibraryAccessors = new PlayCoreLibraryAccessors(owner);
        private final PlayServicesLibraryAccessors laccForPlayServicesLibraryAccessors = new PlayServicesLibraryAccessors(owner);

        public PlayLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>play.core</b>
         */
        public PlayCoreLibraryAccessors getCore() {
            return laccForPlayCoreLibraryAccessors;
        }
    ...
    public static class PlayCoreLibraryAccessors extends SubDependencyFactory {

        public PlayCoreLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>ktx</b> with <b>com.google.android.play:core-ktx</b> coordinates and
         * with version reference <b>google.coreKtx</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("play.core.ktx");
        }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>instantapps</b> with <b>com.google.android.gms:play-services-instantapps</b> coordinates and
         * with version reference <b>playServicesInstantapps</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getInstantapps() {
            return create("play.services.instantapps");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>acra</b> with value <b>5.11.2</b>
         * <p>
         ...
         */
        public Provider<String> getAcra() { return getVersion("acra"); }
        ...
        /**
         * Version alias <b>amplitude</b> with value <b>2.32.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAmplitude() { return getVersion("amplitude"); }

        /**
         * Version alias <b>android</b> with value <b>8.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>bugsnagAndroid</b> with value <b>5.31.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getBugsnagAndroid() { return getVersion("bugsnagAndroid"); }
        ...
        /**
         * Version alias <b>coreSplashscreen</b> with value <b>1.1.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>gdx</b> with value <b>1.12.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>koinAndroid</b> with value <b>3.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>konfettiXml</b> with value <b>2.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKonfettiXml() { return getVersion("konfettiXml"); }
        ...
        /**
         * Version alias <b>mockitoCore</b> with value <b>4.6.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mockitoKotlin</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>orchestrator</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOrchestrator() { return getVersion("orchestrator"); }
        ...
        /**
         * Version alias <b>playServicesInstantapps</b> with value <b>18.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesInstantapps() { return getVersion("playServicesInstantapps"); }
        ...
        /**
         * Version alias <b>robolectric</b> with value <b>4.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>wearMinSdk</b> with value <b>25</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWearMinSdk() { return getVersion("wearMinSdk"); }

        /**
         * Version alias <b>wearTargetSdk</b> with value <b>33</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWearTargetSdk() { return getVersion("wearTargetSdk"); }
    ...
    public static class GoogleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>google.coreKtx</b> with value <b>1.8.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCoreKtx() { return getVersion("google.coreKtx"); }
    ...
    public static class AndroidPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
        ...
        /**
         * Plugin provider for <b>android</b> with plugin id <b>com.android.application</b> and
         * with version reference <b>android</b>
         * <p>
